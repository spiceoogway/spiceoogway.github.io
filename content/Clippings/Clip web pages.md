...
- ==If a selection is present, it uses the selectio==n. You can use `Ctrl/Cmd+A` to select the entire page.
...
- ![lucide-chevrons-up-down.svg > icon](https://publish-01.obsidian.md/access/f786db9fac45774fa4f0d8112e232d67/Attachments/icons/lucide-chevrons-up-down.svg) **Template** switcher to use saved [templates](https://obsidian.md/help/web-clipper/templates) added in the extension settings.
- ![lucide-more-horizontal.svg > icon](https://publish-01.obsidian.md/access/f786db9fac45774fa4f0d8112e232d67/Attachments/icons/lucide-more-horizontal.svg) **More** button to display page variables you can use in templates.
- ![lucide-highlighter.svg > icon](https://publish-01.obsidian.md/access/f786db9fac45774fa4f0d8112e232d67/Attachments/icons/lucide-highlighter.svg) **Highlighter** button to turn on [highlighting](https://obsidian.md/help/web-clipper/highlight).
- ![lucide-book-icon.svg > icon](https://publish-01.obsidian.md/access/f786db9fac45774fa4f0d8112e232d67/Attachments/icons/lucide-book-icon.svg) **Reader** button to turn on [reading view](https://obsidian.md/help/web-clipper/reader).
- ![lucide-picture-in-picture-2.svg > icon](https://publish-01.obsidian.md/access/f786db9fac45774fa4f0d8112e232d67/Attachments/icons/lucide-picture-in-picture-2.svg) **Embed** button to move Web Clipper from the popup into the page.
- ![lucide-settings.svg > icon](https://publish-01.obsidian.md/access/f786db9fac45774fa4f0d8112e232d67/Attachments/icons/lucide-settings.svg) **Settings** button to open the extension settings.
